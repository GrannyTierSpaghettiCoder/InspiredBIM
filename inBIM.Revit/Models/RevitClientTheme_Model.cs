...
namespace inBIM.Revit.Models
{
    internal class RevitClientTheme_Model : ClientTheme_Model
    {
        ...
        {
            String filename = $"inBIM.Revit.Resources.{clientInformation.Product.ToString()}{Core.Extensions.Enum_Extensions<Core.Enums.Years>.GetDescription(clientInformation.Year)}.jpg";
