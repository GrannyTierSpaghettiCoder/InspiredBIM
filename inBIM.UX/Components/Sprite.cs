...
namespace SIG.Model
{
	 internal class Sprite
	 {
		  ...
		  /// Constructor 2
		  /// </summary>
		  public Sprite(string p_patterns, Brush p_foreground, Size p_pixelSize, Point p_position, int p_sequenceIndex = 0) : this(p_patterns, p_foreground, p_pixelSize, p_position, new int[] { p_sequenceIndex })
		  {
		  }
		  ...
		  {
			   m_text = new FormattedText(p_text, CultureInfo.CurrentUICulture, FlowDirection.LeftToRight, Game._TextTypeFace, Constants.TEXTFONTSIZE, p_foreground);
