...
namespace inBIM.AutoCAD.Models
{
    internal class AutoCADClientTheme_Model : ClientTheme_Model
    {
        ...
        {
            String filename = $"inBIM.AutoCAD.Resources.{clientInformation.Product.ToString()}{Core.Extensions.Enum_Extensions<Core.Enums.Years>.GetDescription(clientInformation.Year)}.jpg";
