...
namespace inBIM.Navisworks.Models
{
    internal class NavisworksClientTheme_Model : ClientTheme_Model
    {
        ...
        {
            String filename = $"inBIM.Navisworks.Resources.{clientInformation.Product.ToString()}{Core.Extensions.Enum_Extensions<Core.Enums.Years>.GetDescription(clientInformation.Year)}.jpg";
